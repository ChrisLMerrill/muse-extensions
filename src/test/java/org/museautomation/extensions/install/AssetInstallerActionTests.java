...
import org.museautomation.extensions.install.actions.*;
...
*/
    ...
    @Test
    public void untargzOneAsActionWithSubfolder() throws IOException
        {
        ExtensionProjectAsset asset = new ExtensionProjectAsset();
        final String archive_filename = "testarchive_with_subfolder.tar.gz";
        asset.setDefaultPath(archive_filename);
        ...
        Map<String, String> parameters = new HashMap<>();
        parameters.put(UntargzOneAsAction.FILENAME_PARAM, "file.ext");
        boolean result = new UntargzOneAsAction().performAction(asset, _folder, parameters, new ExtensionInstallLog(_folder));
